...
Foam::laminar<BasicTurbulenceModel>::DZt() const
{
    ...
    (
        ...
        (
            IOobject
            (
                IOobject::groupName("DZt", this->U_.group()),
            ...
            this->mesh_,
            dimensionedScalar("DZt", dimDynamicViscosity, 0.0)
        )
    );
}
...
Foam::laminar<BasicTurbulenceModel>::DZt
(
    const label patchi
) const
{
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volScalarField>
Foam::laminar<BasicTurbulenceModel>::DZEff() const
{
    return tmp<volScalarField>
    (
        new volScalarField
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::scalarField>
Foam::laminar<BasicTurbulenceModel>::DZEff
(
    const label patchi
) const
{
    return this->rho_*this->nu(patchi);
}
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volScalarField>
Foam::laminar<BasicTurbulenceModel>::correctVarZ(volScalarField& varZ) const
{
